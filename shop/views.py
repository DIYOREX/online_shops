...
from shop.models import Product, Category, Order, ProductModelForm
...
def product_detail(request, pk):
    ...
    return render(request, 'shop/detail.html', {'product': product, 'comments': comments, 'related_products': related_products})
